...
public class DeltaDNAExample : MonoBehaviour {
    ...
    public const string ENVIRONMENT_KEY = "07340666555270785346798059914368";
    public const string COLLECT_URL = "http://collect5099mymzs.deltadna.net/collect/api";
    public const string ENGAGE_URL = "http://engage5099mymzs.deltadna.net/";
